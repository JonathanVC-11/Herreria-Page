                        ...
                        <div>
                            ...
                            {proyecto.image_path && !data.image && (
                                <div style={{ marginTop: '16px' }}>
                                    ...
                                    <img src={proyecto.image_path ? `https://pub-4a2423514ab649f9958a61a720de08df.r2.dev/${proyecto.image_path.replace('/storage/', '').replace(/^\/+/, '')}` : '/imagenes/asador-1.png'} alt={proyecto.title || 'Proyecto'} style={{ height: '80px', borderRadius: '8px', objectFit: 'cover' }} />
                                </div>
                            )}
