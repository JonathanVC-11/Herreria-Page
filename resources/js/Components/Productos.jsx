            ...
            {productosFiltrados.length > 0 ? productosFiltrados.map((p, index) => (
              ...
              >
                <div className="card-image-container">
                  <img src={p.image_path ? `https://pub-4a2423514ab649f9958a61a720de08df.r2.dev/${p.image_path.replace('/storage/', '').replace(/^\/+/, '')}` : '/imagenes/asador-1.png'} alt={p.title || 'Proyecto'} className="product-img" />
          ...
          position: 'relative', background: '#ffffff', borderRadius: '32px', border: '1px solid rgba(148,163,184,0.2)', width: '100%', maxWidth: '1000px', maxHeight: '90vh', overflowY: 'auto', boxShadow: '0 40px 100px rgba(0,0,0,0.1)', boxSizing: 'border-box'
           ...
           <div className="detail-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '48px', padding: '40px' }}>
             <div className="detail-image-wrapper">
               <img src={seleccionado.image_path ? `https://pub-4a2423514ab649f9958a61a720de08df.r2.dev/${seleccionado.image_path.replace('/storage/', '').replace(/^\/+/, '')}` : '/imagenes/asador-1.png'} alt={seleccionado.title || 'Proyecto'} className="detail-img" />
